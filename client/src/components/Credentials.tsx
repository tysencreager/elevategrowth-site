...
export default function Credentials({
  ...
  return (
    <section className="py-10 md:py-16 lg:py-20 bg-accent/20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {credentials.map((credential, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col items-center text-center p-6 bg-card rounded-lg border border-card-border hover:-translate-y-1 transition-transform duration-300"
